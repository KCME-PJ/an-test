...
$wo_id = htmlspecialchars($_GET['wo_id']);
$sql = <<<SQL
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                        ...
                        <li role="presentation" class="">
                          <a href="#tab_content2" id="profile-tab1" role="tab" data-toggle="tab"
                          aria-expanded="false">高所作業内容確認</a>
                        </li>
                        <li role="presentation" class="">
                        ...
                        <li role="presentation" class="">
                          <a href="#tab_content4" id="profile-tab3" role="tab" data-toggle="tab"
                      ...
                      <div id="myTabContent" class="tab-content">
                        <div id="tab_content1" class="tab-pane fade active in"
                          ...
                          <form class="form-horizontal" action="receipt_end-edit_done.php"
...
?>
                              ...
                              <div class="col-md-3 col-sm-3 col-xs-12 form-group has-feedback">
                                <select name="weather" class="form-control">
                                  <option value="<?php echo $wt_id ?>"><?php echo $weather ?></option>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-9 col-sm-9 col-xs-12 form-group has-feedback">
                                <textarea name="operator" class="form-control"
                                  rows="3" align="left"><?php echo $operator ?></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              ...
                              <div class="col-md-9 col-sm-9 col-xs-12 form-group has-feedback">
                                <textarea name="work" class="form-control"
                                  rows="3" align="left"><?php echo $work ?></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              ...
                              <div class="col-md-9 col-sm-9 col-xs-12 form-group has-feedback">
                                <textarea name="ky" class="form-control"
                                  rows="3" align="left"><?php echo $ky ?></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12">終了確認事項</label>
                              <div class="col-md-9 col-sm-9 col-xs-12 form-group has-feedback">
                                <textarea name="end_comment" class="form-control"
                                  rows="3" align="left" required></textarea>
                                <div class="help-block with-errors"></div>
                              </div>
                              <label class="control-label col-md-3 col-sm-3 col-xs-12">終了フラグ</label>
                              <div class="col-md-3 col-sm-3 col-xs-12 form-group has-feedback">
                                <input type="number" name="end_flag" class="form-control"
                                value="<?php echo $visitors ?>">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              <div class="col-md-6 col-md-offset-3">
                                ...
                                <button type="submit" class="btn btn-success">終了</button>                             
                              </div>
                            </div>
                          </form>
                        </div>
                        ...
                        <div id="tab_content4" class="tab-pane fade" role="tabpanel" aria-labelledby="profile-tab">
