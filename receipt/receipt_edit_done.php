...
UPDATE works
SET re_id=?, receipt_date=?, receipt_time=?, visitors=?, manager=?, wt_id=?, operator=?, work=?, ky=?, do_flag=?
WHERE wo_id=?
SQL;
    ...
    $stmt->bindValue(11, $wo_id, PDO::PARAM_INT);
    ...
    header("Location: ./receipt_edit_done01.php?id=$wo_id");
