...
try {
    ...
    $co_id1 = htmlspecialchars($row['co_id']);
    $co_name1 = htmlspecialchars($row['co_name']);
    $co_url = htmlspecialchars($row['co_url']);
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form class="form-horizontal" action="profile_edit_done.php" method="post" name="form" id="form">
