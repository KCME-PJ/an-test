          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>DepartmentAdd-page Example</h3>
              </div>              
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>DepartmentAdd-page Example <small>other</small></h2>
...
?>
                    <form class="form-horizontal" action="dp_add_done.php" method="post" name="form"
                      id="form" data-toggle="validator">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">部門名</label>
                        <div class="col-md-9 col-sm-9 col-xs-12 form-group has-feedback">
                          <input type="text" name="name" class="form-control has-feedback-left"
                          id="inputSuccess1" placeholder="安全品質部" required>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12 form-group has-feedback">
                          ...
                          id="inputSuccess2" minlength="8" maxlength="8" placeholder="13E14210"
