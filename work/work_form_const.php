            ...
            <div class="row">
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" action="work_form_done.php"
                    enctype="multipart/form-data" method="post" name="form" id="form" data-toggle="validator">
                      ...
                      <div class="form-group">
                        <label class="col-md-3 col-sm-3 col-xs-12 control-label">高所作業</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <div class="radio">
                            <label>
                              <input type="radio" checked="" value="1"
                              id="optionsRadios1" name="aerial_work" required> 有
                            </label>
                          </div>
                          <div class="radio">
                            <label>
                              <input type="radio" value="0"
                              id="optionsRadios2" name="aerial_work"> 無
                            </label>
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-md-3 col-sm-3 col-xs-12 control-label">経路高所</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <div class="radio">
                            <label>
                              <input type="radio" checked="" value="1"
                              id="optionsRadios1" name="aerial-route" required> 有
                            </label>
                          </div>
                          <div class="radio">
                            <label>
                              <input type="radio" value="0"
                              id="optionsRadios2" name="aerial-route"> 無
                            </label>
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">施工審議実施日</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input name="sinngi_date" type="date" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">施工審議参加者</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <textarea name="sinngi_member" class="form-control" rows="1"
                          placeholder="京セラ太郎、京セラ次郎、・・・" required></textarea>
                          <div class="help-block with-errors"></div>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label class="col-md-3 col-sm-3 col-xs-12 control-label">KCME立会者</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <div class="radio">
                            <label>
                              <input type="radio" checked="" value="0"
                              id="optionsRadios1" name="tachiai" onClick="tachiai-flg0(this.checked);" required/> 無
                            </label>
                          </div>
                          <div class="radio">
                            <label>
                              <input type="radio" value="1"
                              id="optionsRadios2" name="tachiai" onClick="tachiai-flg1(this.checked);"/> 有
                            </label>
                          </div>
                          <label class="col-md-3 col-sm-3 col-xs-12 control-label">KCME立会者氏名</label>
                          <div class="col-md-9 col-sm-9 col-xs-12">
                            <textarea name="tachiai_name" class="form-control" id="tachiai-name" rows="1" 
                            placeholder="京セラ太郎、・・・"></textarea>
                            <div class="help-block with-errors"></div>
                          </div>
                        </div>
                      </div>
